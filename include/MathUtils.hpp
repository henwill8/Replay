...
// https://gist.github.com/xanathar/735e17ac129a72a277ee#file-easing-cs-L118
...
UnityEngine::Quaternion EaseLerp(UnityEngine::Quaternion value1, UnityEngine::Quaternion value2, float time, float deltaTime)
{
    return UnityEngine::Quaternion(EasedLerp(value1.x, value2.x, time, deltaTime), EasedLerp(value1.y, value2.y, time, deltaTime), EasedLerp(value1.z, value2.z, time, deltaTime), EasedLerp(value1.w, value2.w, time, deltaTime));
}
